...
FILE_CONFIGS = [
    ...
    # {
    #     "path": "word/10times_05/shakana.wav",
    #     "tone_ranges": [
    #          (1.0, 2.0),   # 1回目
    #         # (1.5, 2.5),   # 2回目
    #         # (3.0, 4.0),   # 3回目
    ...
    # },
    # {
    #     "path": "word/10times_05/thakana.wav",
    #     "tone_ranges": [
    #          (1.0, 2.0),   # 1回目
    #         # (1.5, 2.5),   # 2回目
    #         # (3.0, 4.0),   # 3回目
    ...
    # },
    # {
    #     "path": "word/10times_05/tyakana.wav",
    #     "tone_ranges": [
    #          (1.0, 2.0),   # 1回目
    #         # (1.5, 2.5),   # 2回目
    #         # (3.0, 4.0),   # 3回目
    ...
    # },
    # {
    #     "path": "word/10times_05/takana.wav",
    #     "tone_ranges": [
    #          (1.0, 2.0),   # 1回目
    #         # (1.5, 2.5),   # 2回目
    #         # (3.0, 4.0),   # 3回目
...
OUTPUT_DIR  = "word/10times_ad"  # すべての結果をまとめるフォルダ
