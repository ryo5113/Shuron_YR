...
def rename_wavs_to_sequential(folder: str, digits: int = 2, start: int = 1) -> None:
    """
    ...
    print(f"完了: {len(wavs)}個のwavを {start:0{digits}d}.wav から連番にリネームしました。")


if __name__ == "__main__":
    # ここを自分のフォルダパスに変更してください（例: r"C:\data\wavs" など）
    target_folder = r"C:\Users\edu01\Documents\GitHub\Shuron_YR\Sound\sata_ML12\tya\cleaned_audio_chunks\voiced"
    rename_wavs_to_sequential(target_folder, digits=2, start=91)
