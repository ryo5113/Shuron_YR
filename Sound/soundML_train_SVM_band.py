...
def main():
    ...
    parser.add_argument("--wav_root", type=str, default="word_Ex1/SVM_wav_dataset_Y",
                        help="ラベル別にwavが入っているルートフォルダ")
    parser.add_argument("--model_dir", type=str, default="word_Ex1/SVM_wav_dataset_Y/trained_A_svm_model_band",
                        help="出力先フォルダ")
